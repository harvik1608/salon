...
define('APP_KEY','Beauty');
define('RESPONSE_STATUS','status');
define('RESPONSE_MESSAGE','message');
define('RESPONSE_FLAG_FAIL',100);
define('RESPONSE_FLAG_FAIL_MOBILE',400);
define('RESPONSE_FLAG_SUCCESS',200);
define('RESPONSE_CLOSE',400);
define('RESPONSE_INVALID_KEY',"Invalid Key");
define('RESPONSE_DATA',"data");
define('LIMIT',10);
define('TOTAL_COUNT',"total_count");
define('CURRENT_PAGE',"current_page");
define('NEXT_PAGE',"next_page");
define('TOTAL_PAGE',"total_pages");
define('LIMIT_WORD',"limit");
