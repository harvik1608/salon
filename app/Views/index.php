                ...
                <div class="row">
                    ...
                    ?>
                                <div class="col-md-3 col-sm-6 m-b30">
                                    <div class="abouts-2">
                                        <div class="dez-media"> 
                                            <a href="<?php echo base_url(); ?>treatment/<?php echo $val['id']; ?>"><img src="<?php echo $val['avatar']; ?>" alt="<?php echo $val['name']; ?>" class="lazy"></a> 
                                        </div>
                                        <div class="about-info p-a25 text-center">
                                            <h4 class="dez-title m-t0 m-b10">
                                                <a href="<?php echo base_url(); ?>treatment/<?php echo $val['id']; ?>" class="font-weight-600">
                                                    <?php echo $val['name']; ?>
                                                </a>
                                            </h4>
