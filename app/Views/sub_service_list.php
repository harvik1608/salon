			...
			<tbody>
				...
				?>
						<tr>
							...
							?>
												<td align="center" valign="middle" style="font-size: 11px;cursor: pointer;" onclick="add_to_cart('<?php echo $service['id']; ?>','<?php echo $field['id']; ?>','<?php echo $service['name']; ?>','<?php echo $field['caption']; ?>','<?php echo $service_price; ?>','<?php echo $field['duration']; ?>','<?php echo $flag; ?>');">
													<?php
														if($field['caption'] == "")
														{
													?>
													...
													?>
															<small><b><?php echo $field['caption']; ?></b></small>
															<br>
