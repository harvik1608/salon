$(function () {
    ...
    $('.gallery_filter_2').on('click', 'button', function () {
        var filterValue = $(this).attr('data-filter');
        $grid2.isotope({
            filter: filterValue
        });
    ...
    //active class
    $('.gallery_filter_2 button').on("click", function (event) {
    ...
    $(".info_edit_btn").on("click", function () {
        $(".personal_area").addClass("edit_form");
    });

    $(".info_edit_cancel_btn").on("click", function () {
        $(".personal_area").removeClass("edit_form");
    });
